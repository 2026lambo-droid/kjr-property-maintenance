        ...
        <div className="container">
          <div className="cs_hero_in">
            <div className="cs_hero_text">
              {data.eyebrow && (
                <p className="cs_hero_eyebrow cs_white_color cs_mb_8 mb-0" data-aos="fade-up">
                  {data.eyebrow}
                </p>
              )}
              <h1
                className="cs_hero_title cs_fs_100 cs_normal cs_mb_12 cs_white_color wow fadeInUp"
                data-aos="fade-up"
              ...
              <div className="cs_hero_btns">
                ...
                {data.btnUrl2 && (data.btnUrl2.startsWith("tel:") || data.btnUrl2.startsWith("mailto:")) ? (
                  <a
                    href={data.btnUrl2}
                    data-aos="fade-left"
                ...
                {data.funfact.trustIndicators && (
                  <div className="cs_hero_funfact_indicators">
                    {data.funfact.trustIndicators.map((item, index) => (
                      <div key={index} className="cs_hero_funfact_item">
                        <Icon icon={item.icon} width="14" height="14" className="cs_hero_funfact_icon" />
                        <span className="cs_white_color cs_hero_funfact_item_text">{item.text}</span>
                      </div>
                    ))}
                  </div>
                )}
            ...
            <div className="cs_hero_box wow fadeInUp" data-aos="fade-up">
              ...
              ></h3>
              {data.box.contacts ? (
                <div className="cs_hero_box_contacts">
                  {data.box.contacts.map((contact, i) => (
                    <div key={i} className="cs_hero_box_contact">
                      <span className="cs_hero_box_contact_label">
                        {contact.label} {contact.name}
                      </span>
                      <a href={`tel:${contact.tel}`} className="cs_hero_box_contact_tel cs_white_color">
                        {contact.tel.replace(/(\d{3})(\d{3})(\d{4})/, "($1) $2-$3")}
                      </a>
                    </div>
                  ))}
                </div>

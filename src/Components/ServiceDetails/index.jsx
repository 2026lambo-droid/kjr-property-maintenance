        ...
        <div className="row cs_gap_x_40 cs_gap_y_30">
          <div className="col-lg-7">
            ...
            {data.video.url ? (
              ...
              <div
                className="cs_video_block cs_style_1 cs_type_1 cs_bg_filed cs_center cs_radius_20"
                style={{
                  backgroundImage: `url(${data.video.bgImage})`,
                  height: data.video.imageContain ? "360px" : "380px",
                  backgroundSize: data.video.imageContain ? "contain" : "cover",
                  backgroundPosition: "center",
                  backgroundColor: data.video.imageContain ? "#f5f5f5" : undefined,
                }}
              />
            )}
            <VideoModal
          ...
          <>
            ...
            <div className="row">
              <div className="col-12">
                <div
                  className="cs_service_detail_secondary_image cs_bg_filed cs_center cs_radius_20"
                  style={{ backgroundImage: `url(${data.secondaryImage})` }}
                />
              </div>
            </div>
          </>
